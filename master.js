...
function city_input(){
  ...
  // 현재날씨 및 최저 최고 기온 출력
    ...
    .then((data) => {
      ...
      if(weather=="Clear")
      document.getElementById("temp_cur_img").src = "/img/temp_cur_img.png"; //맑음 사진
    
      else if(weather=="Rain")
      document.getElementById("temp_cur_img").src = "/img/temp_cur_img.png"; //비 사진
    
      else if(weather=="Snow")
      document.getElementById("temp_cur_img").src = "/img/temp_cur_img.png"; //눈 사진
  ...
  document.getElementById('hourly_temp6').innerHTML= hourly_temp6;
      ...
      for(let i=0; i<6; i++){
          ...
          document.getElementById("temp_fut"+i+"_img").src = "/img/temp_cur_img.png"; //맑음 사진

          else if(weather_fut[i]=="Rain")
          document.getElementById("temp_fut"+i+"_img").src = "/img/temp_cur_img.png"; //비 사진
  
          else if(weather_fut[i]=="Snow")
          document.getElementById("temp_fut"+i+"_img").src = "/img/temp_cur_img.png"; //눈 사진
  
          else if(weather_fut[i]=="Clouds")
          document.getElementById("temp_fut"+i+"_img").src = "/img/temp_cur_img.png"; 
